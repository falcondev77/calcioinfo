...
/**
 * Squadre Serie A - sincronizzate con database.sql.
 * Restituisce un array indicizzato per id.
 */
function teams_all(): array {
    ...
    $rows = [
        ...
        ['id' => 2,  'name' => 'Monza',      'slug' => 'monza',      'city' => 'Monza',     'primary' => '#E2001A', 'secondary' => '#FFFFFF', 'aliases' => ['monza','brianzoli','biancorossi']],
        ['id' => 3,  'name' => 'Fiorentina', 'slug' => 'fiorentina', 'city' => 'Firenze',   'primary' => '#592C82', 'secondary' => '#FFFFFF', 'aliases' => ['fiorentina','viola','gigliati']],
        ['id' => 4,  'name' => 'Roma',       'slug' => 'roma',       'city' => 'Roma',      'primary' => '#8E1F2F', 'secondary' => '#F0BC42', 'aliases' => ['roma','giallorossi','as roma','lupi']],
        ...
        ['id' => 7,  'name' => 'Cagliari',   'slug' => 'cagliari',   'city' => 'Cagliari',  'primary' => '#A50026', 'secondary' => '#0066B3', 'aliases' => ['cagliari','sardi','isolani']],
    ...
    $cache = [];
    foreach ($rows as $r) $cache[$r['id']] = $r;
    return $cache;
}

function team_by_id(int $id): ?array {
    $all = teams_all();
    return $all[$id] ?? null;
}
